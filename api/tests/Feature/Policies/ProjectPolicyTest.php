...
class ProjectPolicyTest extends TestCase
{
    ...
    public function test_only_a_chef_admin_or_existing_project_manager_can_create_a_project(): void
    {
        ...
        // Cohérent avec TaskPolicy : le directeur ne crée pas de projets non plus.
        $this->assertFalse($directeur->can('create', Project::class));
        // Un employé sans aucun rôle projet ne peut pas en créer.
